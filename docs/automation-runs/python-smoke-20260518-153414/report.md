...
Generated: 2026-05-18T15:34:14<br>
...
| automated_market_gate | PASS | `pnpm market:ready:automated` | 1.03s | 1 | nested subprocess blocked by environment |
| new_validation_report | PASS | `pnpm validation:new` | 0.51s | 0 |  |
| extension_build | FAIL | `pnpm build:extension` | 2.81s | 1 | extension output locked |
...
```json
{
  "latest_release_run": "C:\\Users\\rajan\\OneDrive\\Desktop\\Autotime-EU-Apply\\docs\\release-runs\\2026-05-18T14-34-15-797Z.md",
  "latest_automation_run": "C:\\Users\\rajan\\OneDrive\\Desktop\\Autotime-EU-Apply\\docs\\automation-runs\\2026-05-10-agent-browser-ui-walkthrough.md",
  "latest_founder_validation_run": "C:\\Users\\rajan\\OneDrive\\Desktop\\Autotime-EU-Apply\\docs\\founder-validation-runs\\2026-05-18T14-34-16-365Z-manual-validation.md",
  "python_report_dir": "C:\\Users\\rajan\\OneDrive\\Desktop\\Autotime-EU-Apply\\docs\\automation-runs\\python-smoke-20260518-153414"
}
```
...
Release check report written to docs\release-runs\2026-05-18T14-34-15-797Z.md
...
Founder validation report created at docs\founder-validation-runs\2026-05-18T14-34-16-365Z-manual-validation.md
```
...
Note: the extension build output appears locked. Close Chrome extension pages, stop any dev server using the extension output, pause OneDrive sync if needed, then rerun.
...
[31mÃ—[39m Command failed after 462 ms
...
[41m[30m ERROR [39m[49m EPERM: operation not permitted, unlink 'C:\Users\rajan\OneDrive\Desktop\Autotime-EU-Apply\apps\extension\.output\chrome-mv3\manifest.json'
