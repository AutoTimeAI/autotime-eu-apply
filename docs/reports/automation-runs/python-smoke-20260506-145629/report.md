...
|---|---:|---|---:|---:|---|
| node_version | PASS | `node --version` | 0.02s | 0 |  |
| pnpm_version | PASS | `pnpm --version` | 0.3s | 0 |  |
| automated_market_gate | FAIL | `pnpm market:ready:automated` | 1.08s | 1 |  |
...
```json
{
  "latest_release_run": "C:\\Users\\rajan\\OneDrive\\Desktop\\Autotime-EU-Apply\\docs\\release-runs\\2026-05-06T13-56-31-010Z.md",
  ...
  "python_report_dir": "C:\\Users\\rajan\\OneDrive\\Desktop\\Autotime-EU-Apply\\docs\\automation-runs\\python-smoke-20260506-145629"
}
```
...
Release check report written to docs\release-runs\2026-05-06T13-56-31-010Z.md
