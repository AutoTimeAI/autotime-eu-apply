...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"Workday",slug:"workday",category:"ats",domains:["myworkdayjobs.com"],atsKey:"workday",expectedCaptureMode:"selector-extraction",capture:"partial",autofill:"unsupported",nativeFeed:"unsupported",lastVerifiedAt:VERIFIED_AT,fixture:fixture("workday"),liveCheckUrl:"https://workday.wd5.myworkdayjobs.com/Workday",publicLimitation:"Tenant-specific pages are captured heuristically; multi-step forms require manual review. Applying requires a real candidate account (plain email/password, no CAPTCHA present) - re-investigated 2026-09-08 but left genuinely unresolved rather than confirmed blocked; see atsFieldMaps.ts for what was and wasn't established." },
