...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"Greenhouse",slug:"greenhouse",category:"ats",domains:["boards.greenhouse.io","job-boards.greenhouse.io"],atsKey:"greenhouse",expectedCaptureMode:"api-reference",capture:"verified",autofill:"unsupported",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("greenhouse"),liveCheckUrl:"https://boards-api.greenhouse.io/v1/boards/stripe/jobs?content=true",publicLimitation:"Native public feed; custom employer forms can differ." },
