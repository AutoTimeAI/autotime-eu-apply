...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"Ashby",slug:"ashby",category:"ats",domains:["jobs.ashbyhq.com"],atsKey:"ashby",expectedCaptureMode:"api-reference",capture:"verified",autofill:"unsupported",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("ashby"),liveCheckUrl:"https://api.ashbyhq.com/posting-api/job-board/ashby",publicLimitation:"Native public feed; custom questions remain manual." },
  ...
  { platform:"BambooHR",slug:"bamboohr",category:"ats",domains:["bamboohr.com"],atsKey:"bamboohr",expectedCaptureMode:"manual-only",capture:"partial",autofill:"unsupported",nativeFeed:"unsupported",lastVerifiedAt:VERIFIED_AT,fixture:fixture("bamboohr"),liveCheckUrl:"https://bamboohr.com/careers",publicLimitation:"Generic capture only; no native feed integration." },
  { platform:"Teamtailor",slug:"teamtailor",category:"ats",domains:["teamtailor.com"],atsKey:"teamtailor",expectedCaptureMode:"manual-only",capture:"partial",autofill:"unsupported",nativeFeed:"unsupported",lastVerifiedAt:VERIFIED_AT,fixture:fixture("teamtailor"),liveCheckUrl:"https://career.teamtailor.com/",publicLimitation:"Generic capture only; no native feed integration." },
  { platform:"Recruitee",slug:"recruitee",category:"ats",domains:["recruitee.com"],atsKey:"recruitee",expectedCaptureMode:"api-reference",capture:"verified",autofill:"unsupported",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("recruitee"),liveCheckUrl:"https://trustedshops.recruitee.com/api/offers/",publicLimitation:"Native public careers feed; custom questions remain manual." },
  { platform:"Jobvite",slug:"jobvite",category:"ats",domains:["jobvite.com"],atsKey:"jobvite",expectedCaptureMode:"manual-only",capture:"partial",autofill:"unsupported",nativeFeed:"unsupported",lastVerifiedAt:VERIFIED_AT,fixture:fixture("jobvite"),liveCheckUrl:"https://jobs.jobvite.com/",publicLimitation:"Generic capture only; no native feed integration." },
  { platform:"Personio",slug:"personio",category:"ats",domains:["jobs.personio.de","jobs.personio.com"],atsKey:"personio",expectedCaptureMode:"api-reference",capture:"verified",autofill:"unsupported",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("personio"),liveCheckUrl:"https://personio.jobs.personio.de/xml",publicLimitation:"Native public feed; employer-specific forms can differ." },
] as const;
