...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"Greenhouse",slug:"greenhouse",category:"ats",domains:["boards.greenhouse.io","job-boards.greenhouse.io"],atsKey:"greenhouse",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("greenhouse"),liveCheckUrl:"https://boards-api.greenhouse.io/v1/boards/stripe/jobs?content=true",publicLimitation:"Native public feed and reviewed field filling; custom employer forms can differ." },
  ...
  { platform:"SmartRecruiters",slug:"smartrecruiters",category:"ats",domains:["jobs.smartrecruiters.com"],atsKey:"smartrecruiters",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("smartrecruiters"),liveCheckUrl:"https://api.smartrecruiters.com/v1/companies/SmartRecruiters/postings?limit=10&destination=PUBLIC",publicLimitation:"Native public feed metadata; full advert enrichment and custom questions may require review." },
