...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"BambooHR",slug:"bamboohr",category:"ats",domains:["bamboohr.com"],atsKey:"bamboohr",expectedCaptureMode:"manual-only",capture:"partial",autofill:"verified",nativeFeed:"unsupported",lastVerifiedAt:"2026-09-08",fixture:fixture("bamboohr"),liveCheckUrl:"https://bamboohr.com/careers",publicLimitation:"Generic capture and reviewed field filling; no native feed integration." },
  { platform:"Teamtailor",slug:"teamtailor",category:"ats",domains:["teamtailor.com"],atsKey:"teamtailor",expectedCaptureMode:"manual-only",capture:"partial",autofill:"verified",nativeFeed:"unsupported",lastVerifiedAt:"2026-09-08",fixture:fixture("teamtailor"),liveCheckUrl:"https://career.teamtailor.com/",publicLimitation:"Generic capture and reviewed field filling; no native feed integration." },
  ...
  { platform:"Jobvite",slug:"jobvite",category:"ats",domains:["jobvite.com"],atsKey:"jobvite",expectedCaptureMode:"manual-only",capture:"partial",autofill:"verified",nativeFeed:"unsupported",lastVerifiedAt:"2026-09-08",fixture:fixture("jobvite"),liveCheckUrl:"https://jobs.jobvite.com/",publicLimitation:"Generic capture and reviewed field filling; no native feed integration." },
