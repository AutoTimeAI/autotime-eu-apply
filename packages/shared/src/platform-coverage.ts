...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"Lever",slug:"lever",category:"ats",domains:["jobs.lever.co"],atsKey:"lever",expectedCaptureMode:"api-reference",capture:"verified",autofill:"unsupported",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("lever"),liveCheckUrl:"https://api.lever.co/v0/postings/palantir?mode=json",publicLimitation:"Native public feed; custom questions remain manual." },
