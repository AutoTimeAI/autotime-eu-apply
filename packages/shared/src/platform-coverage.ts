...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"Recruitee",slug:"recruitee",category:"ats",domains:["recruitee.com"],atsKey:"recruitee",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("recruitee"),liveCheckUrl:"https://trustedshops.recruitee.com/api/offers/",publicLimitation:"Native public careers feed and reviewed field filling; custom questions remain manual." },
