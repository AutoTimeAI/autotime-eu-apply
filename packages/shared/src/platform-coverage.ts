...
export const PLATFORM_COVERAGE: readonly PlatformCoverage[] = [
  ...
  { platform:"Wellfound",slug:"wellfound",category:"job_board",domains:["wellfound.com","angel.co"],expectedCaptureMode:"selector-extraction",capture:"partial",autofill:"partial",nativeFeed:"unsupported",lastVerifiedAt:VERIFIED_AT,fixture:fixture("wellfound"),liveCheckUrl:"https://wellfound.com/jobs",publicLimitation:"Reviewed generic capture and field filling; sign-in-only flows are not live-tested." },
  ...
  { platform:"Greenhouse",slug:"greenhouse",category:"ats",domains:["boards.greenhouse.io","job-boards.greenhouse.io"],atsKey:"greenhouse",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("greenhouse"),liveCheckUrl:"https://job-boards.greenhouse.io/",publicLimitation:"Native public feed and reviewed field filling; custom employer forms can differ." },
  { platform:"Lever",slug:"lever",category:"ats",domains:["jobs.lever.co"],atsKey:"lever",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("lever"),liveCheckUrl:"https://jobs.lever.co/",publicLimitation:"Native public feed and reviewed field filling; custom questions remain manual." },
  ...
  { platform:"Ashby",slug:"ashby",category:"ats",domains:["jobs.ashbyhq.com"],atsKey:"ashby",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("ashby"),liveCheckUrl:"https://jobs.ashbyhq.com/ashby",publicLimitation:"Native public feed and reviewed field filling; custom questions remain manual." },
  { platform:"SmartRecruiters",slug:"smartrecruiters",category:"ats",domains:["jobs.smartrecruiters.com"],atsKey:"smartrecruiters",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("smartrecruiters"),liveCheckUrl:"https://jobs.smartrecruiters.com/SmartRecruiters",publicLimitation:"Native public feed metadata; full advert enrichment and custom questions may require review." },
  ...
  { platform:"Recruitee",slug:"recruitee",category:"ats",domains:["recruitee.com"],atsKey:"recruitee",expectedCaptureMode:"manual-only",capture:"partial",autofill:"partial",nativeFeed:"unsupported",lastVerifiedAt:VERIFIED_AT,fixture:fixture("recruitee"),liveCheckUrl:"https://recruitee.com/careers",publicLimitation:"Generic capture and reviewed field filling; no native feed integration." },
  ...
  { platform:"Personio",slug:"personio",category:"ats",domains:["jobs.personio.de","jobs.personio.com"],atsKey:"personio",expectedCaptureMode:"api-reference",capture:"verified",autofill:"partial",nativeFeed:"verified",lastVerifiedAt:VERIFIED_AT,fixture:fixture("personio"),liveCheckUrl:"https://www.personio.com/about-personio/careers/",publicLimitation:"Native public feed and reviewed field filling; employer-specific forms can differ." },
] as const;
