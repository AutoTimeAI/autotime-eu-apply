...
export default function ProfileSummary() {
  ...
  return (
    <main className="workflow-page profile-page">
      <ProductPageHeader eyebrow="Profile" title={profile.full_name || "Your profile"} description="Your confirmed personal details, target markets, professional links and canonical CV." action={<Link className="button-secondary" href="/dashboard/profile-evidence">Review evidence &amp; readiness</Link>}/>
