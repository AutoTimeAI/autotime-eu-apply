...
export default function ProfileConnect() {
  ...
  return <section className="workflow-page profile-connect-page" aria-labelledby="profile-connect-title"><p className="product-eyebrow">Connect</p><h2 id="profile-connect-title">Contacts and follow-ups</h2><p>Discover and draft across tracked applications. AutoTime never connects, sends messages, or scrapes LinkedIn.</p>
