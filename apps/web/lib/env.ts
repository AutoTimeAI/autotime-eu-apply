...
const publicEnvSchema = z.object({
  ...
  NEXT_PUBLIC_POSTHOG_KEY: requiredString("NEXT_PUBLIC_POSTHOG_KEY"),
  NEXT_PUBLIC_POSTHOG_HOST: requiredString("NEXT_PUBLIC_POSTHOG_HOST").url(
    "NEXT_PUBLIC_POSTHOG_HOST must be a valid URL"
  )
})
