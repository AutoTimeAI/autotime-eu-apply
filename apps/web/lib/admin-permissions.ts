...
export const adminPermissions = [
  ...
  "market_data:read",
  "market_data:refresh",
  "mobility_sources:review",
  "mobility_experts:record",
  "mobility_claims:review",
  "mobility_rules:activate",
  "mobility_rules:stage",
  "mobility_rules:evaluate",
  "mobility_fixtures:register",
  "mobility_corrections:review",
  "feature_flags:read",
  "feature_flags:write",
  "audit:read",
